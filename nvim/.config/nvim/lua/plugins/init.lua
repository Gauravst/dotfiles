...

  {
    ...
    config = function()
      require("octo").setup {
        ...
        ssh_aliases = {}, -- SSH aliases to be used instead of the full repository URL
        reaction_viewer_hint_icon = "", -- marker for user reactions
        user_icon = " ", -- user icon
        timeline_marker = "", -- timeline marker
        timeline_indent = "2", -- timeline indentation
        right_bubble_delimiter = "", -- bubble delimiter for right side
        left_bubble_delimiter = "", -- bubble delimiter for left side
        ...
        mappings = {
          ...
          review_diff = {
            ...
            add_review_suggestion = { lhs = "<space>sa", desc = "add a new suggestion" },
